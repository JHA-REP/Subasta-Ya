...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SubastaYa — Subastas en vivo" },
      {
        name: "description",
        content:
          "Plataforma de subastas en tiempo real: pujá en vivo, publicá tus productos y gestioná tu billetera.",
      },
      { property: "og:title", content: "SubastaYa — Subastas en vivo" },
      {
        property: "og:description",
        content: "Pujas en tiempo real, anti-sniping y billetera virtual.",
      },
